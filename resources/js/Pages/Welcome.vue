          ...
          <form @submit.prevent="submit()">
            <div class="space-y-4">
              <div class="">
                ...
                <div class="mt-2">
                  <TextInput class="w-full" placeholder="https://..." v-model="url"/>
                </div>

                <div>
                  <ul class="text-white h-4">
                    <li v-for="error in errors.url" :key="error">{{ error }}</li>
                  </ul>
                </div>
              </div>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                  <PrimaryButton :disabled="isLoading">
                    <div v-if="isLoading" class="flex items-center gap-2">
                      <LoaderIcon class="h-4 w-4 text-white"/>
                      <span>Loading...</span>
                    </div>
              ...
              <div>
                <ul class="mt-8 text-white space-y-2">
                  <li>http://malware.testing.google.test/testing/malware/</li>
                  <li>https://google.com/random-string-123</li>
                </ul>
              </div>
            </div>
          </form>
